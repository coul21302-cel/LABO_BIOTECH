            ...
            <div class="header-content">
                <div class="logo">
                    <a href="<?php echo SITE_URL; ?>">
                        <img src="<?php echo SITE_URL; ?>/uploads/images/logo.png?v=<?php echo time(); ?>" alt="Logo LBV" class="logo-image">
                        <span class="logo-text">
                            <strong>LBV</strong>
                            <small>Laboratoire de Biotechnologie Végétale</small>
                        </span>
                    </a>
                </div>
                ...
                <nav class="main-nav" id="mainNav">
                    <ul>
                        ...
                        <li><a href="<?php echo SITE_URL; ?>/pages/laboratoire.php" <?php echo (isset($current_page) && $current_page == 'laboratoire') ? 'class="active"' : ''; ?>>Le Laboratoire</a></li>

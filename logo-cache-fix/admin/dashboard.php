...
$stats['alumni'] = $pdo->query("SELECT COUNT(*) FROM alumni WHERE actif = 1")->fetchColumn();
    ...
    <div class="admin-dashboard">
        ...
        <main class="admin-main">
            ...
            <div class="dashboard-stats">
                ...
                <div class="stat-box">
                    <div class="stat-box-icon" style="background: #00bcd4;">
                        <i class="fas fa-user-graduate"></i>
                    </div>
                    <div>
                        <div class="stat-number"><?php echo $stats['alumni']; ?></div>

...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        if ($id) {
            ...
            $stmt = $pdo->prepare("INSERT INTO membres (nom, prenom, email, categorie, specialite, biographie, domaine_recherche, photo) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->execute([$nom, $prenom, $email, $categorie, $specialite, $biographie, $domaine_recherche, $photo]);

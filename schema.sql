...
-- Membres de l'équipe
INSERT INTO membres (nom, prenom, email, categorie, specialite, biographie, domaine_recherche, photo, ordre_affichage) VALUES
('Diop', 'Amadou', 'adiop@labo-biotech.sn', 'Professeur', 'Biotechnologie végétale', 'Professeur titulaire avec 20 ans d\'expérience en amélioration génétique des plantes tropicales.', 'Amélioration génétique des céréales, résistance aux stress abiotiques', 'default-avatar.png', 1),
('Ndiaye', 'Fatou', 'fndiaye@labo-biotech.sn', 'Professeur', 'Biologie moléculaire', 'Spécialiste en biologie moléculaire et génomique fonctionnelle des plantes.', 'Génomique des plantes, marqueurs moléculaires', 'default-avatar.png', 2),
('Seck', 'Moussa', 'mseck@labo-biotech.sn', 'Chercheur', 'Microbiologie végétale', 'Chercheur en interactions plantes-microorganismes et biostimulants.', 'Rhizosphère, symbioses végétales', 'default-avatar.png', 3),
('Fall', 'Aïssatou', 'afall@labo-biotech.sn', 'Chercheur', 'Culture in vitro', 'Experte en multiplication végétative et conservation in vitro.', 'Micropropagation, cryoconservation', 'default-avatar.png', 4),
('Kane', 'Ibrahima', 'ikane@labo-biotech.sn', 'Doctorant', 'Physiologie végétale', 'Doctorant travaillant sur la tolérance à la sécheresse du mil.', 'Stress hydrique, métabolisme végétal', 'default-avatar.png', 5),
('Thiam', 'Mariama', 'mthiam@labo-biotech.sn', 'Doctorant', 'Génétique moléculaire', 'Thèse sur les gènes de résistance aux maladies du riz.', 'Résistance aux pathogènes, QTL mapping', 'default-avatar.png', 6);

-- Projets
INSERT INTO projets (titre, description, objectifs, statut, date_debut, date_fin) VALUES
...
('Conférence internationale AFBG 2024',
 ...
 'Conférence', '2024-06-20', TRUE);

-- Partenaires
INSERT INTO partenaires (nom, type, pays, site_web, actif, ordre_affichage) VALUES
('Université Cheikh Anta Diop de Dakar', 'Université', 'Sénégal', 'https://www.ucad.sn', TRUE, 1),
('IRD - Institut de Recherche pour le Développement', 'Centre de recherche', 'France', 'https://www.ird.fr', TRUE, 2),
('CIRAD - Centre de coopération internationale en recherche agronomique', 'Centre de recherche', 'France', 'https://www.cirad.fr', TRUE, 3),
('ICRISAT - International Crops Research Institute', 'Centre de recherche', 'Inde', 'https://www.icrisat.org', TRUE, 4);

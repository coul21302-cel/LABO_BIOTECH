...
$stmt = $pdo->query("SELECT * FROM actualites WHERE publie = 1 ORDER BY date_publication DESC LIMIT 3");
    ...
    <div class="hero-content">
        <div class="container">
            ...
            <div class="hero-buttons animate-fade-in-delay-2">
                ...
                <a href="<?php echo SITE_URL; ?>/planttfdb-web" class="btn btn-outline-light btn-lg">
